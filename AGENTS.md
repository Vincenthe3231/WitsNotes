...
Guidance for Codex across the entire monorepo.
...
See `client/AGENTS.md` and `server/AGENTS.md` for full command references.
...
- See `client/lib/api/AGENTS.md` for offline mutation pattern details.
